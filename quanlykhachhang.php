...
<body>
    <div id="wrap">
        <div id="menu">
            <ul>
                <a href="index.html"><li ><img src="./img/danhmuc.png" alt="danhmuc"><p>Danh mục</p></li></a>
                <a href=""><li><img src="./img/qlbanhang.png" alt="danhmuc"><p>Quản lý bán hàng</p></li></a>
                ...
                <a href="#"><li id="selected"><img src="./img/khachhang.png" alt="khachhang"><p>Quản lý khách hàng</p></li></a>
